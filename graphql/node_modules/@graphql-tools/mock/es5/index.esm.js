import { __assign, __values, __spread, __awaiter, __generator, __read } from 'tslib';
import { isNullableType, getNullableType, isCompositeType, isAbstractType, isListType, isScalarType, isEnumType, isObjectType, isInterfaceType, isSchema, isUnionType, GraphQLUnionType, GraphQLInterfaceType, defaultFieldResolver, graphql } from 'graphql';
...
var MockStore = /** @class */ (function () {
    ...
    MockStore.prototype.generateValueFromType = function (fieldType) {
        ...
        if (isScalarType(nullableType)) {
            ...
            return __spread(new Array(randomListLength())).map(function () { return _this.generateValueFromType(nullableType.ofType); });
        }
